...
> 给正在完成实证类课程论文或毕业论文的中文本科信息管理专业学生，一套从“我到底该做什么”走到“我凭什么这样写”的本地科研工作流。
...
> **适用对象（v0.2 Beta）：**中文本科信息管理专业学生（如信息管理与信息系统），正在进行实证类课程论文或毕业论文。唯一受支持 Profile 为 `zh-undergrad-information-management-empirical`。
>
> **当前边界：**尚不支持研究生、非信息管理专业或非实证研究场景；适合在受限边界内试用，不应被当作生产级科研、外部事实核验或投稿系统。
